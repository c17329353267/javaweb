...
<div id="container">
	...
	<form action="UserLoginServlet" method="post" id="myform1">
	<div class="login">
		<ul class="form f_l">
			<h1><img src="images/logintitle.gif" alt="会员登录" /></h1>
			<li class="login_list" style="color:red;font-size:14px;">${error }</li>
			<li class="login_list"><label>会员名：</label><input type="text" name="login" />（可包含 a-z、0-9 和下划线）</li>
			<li class="login_list"><label>密&nbsp;&nbsp;&nbsp;码：</label><input type="text" name="pwd" />（至少包含 6 个字符）</li>
			<li class="a_c">
				<img src="images/login.gif" id="loginBtn" onclick="logintarget();" alt="登录" />
			</li>
